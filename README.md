# Laravel 11 + Task-React-App Project
A simple Task Project management application using Laravel 11 and React.
...
8. Start vite server - `npm run dev` (For production)
